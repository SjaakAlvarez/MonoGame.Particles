...
namespace MonoGame.Particles.Samples.GameStateManagement
{
    /// <summary>
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        public void FlipScreens(GameScreen screen1, GameScreen screen2)
        {
            int i = screens.IndexOf(screen1);
            int j = screens.IndexOf(screen2);

            GameScreen temp = screens[i];
            screens[i] = screens[j];
            screens[j] = temp;
        }
